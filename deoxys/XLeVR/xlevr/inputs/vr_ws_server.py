...
class VRControllerState:
    ...
    def __init__(self, hand: str):
        ...
        self.y_axis_rotation = 0.0  # For wrist_yaw (yaw)
        ...
        if 'headset' in data:
            ...
            if headset_data and headset_data.get('position'):
                ...
                headset_goal = ControlGoal(
                    ...
                    wrist_roll_deg=rot.get('z', 0),  # Z-axis rotation (roll)
                    wrist_flex_deg=rot.get('x', 0),   # X-axis rotation (pitch)
                    wrist_yaw_deg=rot.get('y', 0),    # Y-axis rotation (yaw)
                    metadata={
                        "source": "vr_headset",
        ...
        if grip_active:
            ...
            if controller.origin_position is not None:
                ...
                goal = ControlGoal(
                    ...
                    wrist_roll_deg=-controller.z_axis_rotation,  # Z-axis rotation (roll)
                    wrist_flex_deg=-controller.x_axis_rotation,  # X-axis rotation (pitch)
                    wrist_yaw_deg=-controller.y_axis_rotation,   # Y-axis rotation (yaw)
                    metadata={
                        "source": "vr_grip",
